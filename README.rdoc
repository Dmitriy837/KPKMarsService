...
This project just demonstrates my basic skills in Ruby on Rails,
so everything I have to say is just thanks for your attention!
...
The code look even uglier, then it could because of unnatural requirment to store last_date as an integer number, but present in interface with date selectors.
