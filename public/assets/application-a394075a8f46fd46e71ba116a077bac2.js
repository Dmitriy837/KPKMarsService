...
(function() {
  jQuery(function() {
    $(document).on('click', '#flash_notice', function() {
      return $('#flash_notice').remove();
    });
    $(document).on('click', '#flash_alert', function() {
      return $('#flash_alert').remove();
    });
...
(function() {
  jQuery(function() {
    ...
    return $('#flash_alert').click(function() {
      return this.remove();
    });
  });
